...
<head>
	...
	<title>LeumasInc. Aptitude Portal</title>
...
<div id="admin_box">
	...
	<br>
	<button style="float: right;" onclick="damn.dumb0()">client Login</button><br><br>
</div><br><br><br>
	<center>
	...
	<center><p style="font-size: 12px;bottom: 8px; position: absolute; right: 40%;">Samuel Motsepe | Full stack developer<br> An Aptitude Test System for Employee/Employers<br> Developed for Computer and IT clients (Individuals who are computer literate) </p></center>
</body>
</html>
